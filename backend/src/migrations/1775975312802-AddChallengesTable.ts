...
export class AddChallengesTable1775975312802 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."challenges_status_enum" AS ENUM('open', 'active', 'settled', 'expired')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1980733727a12aad16f53de8ba" ON "challenges" ("creatorId") `);
        await queryRunner.query(`CREATE INDEX "IDX_9f256ed73736fd576726a9b42d" ON "challenges" ("marketId", "status") `);
        await queryRunner.query(`CREATE INDEX "IDX_e32b137e223c851193abf6bc7b" ON "challenges" ("creatorId", "status") `);
        await queryRunner.query(`ALTER TABLE "transactions" ADD "isBonus" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "users" ADD "freeCreditGranted" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "users" ADD "bonusBalance" numeric(18,2) NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."transactions_type_enum" AS ENUM('deposit', 'withdrawal', 'bet_placed', 'bet_payout', 'refund', 'dispute_bond', 'dispute_refund', 'referral_bonus', 'free_credit', 'streak_bonus')`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "payment_otps" DROP COLUMN "expiresAt"`);
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD "expiresAt" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment_otps" DROP COLUMN "updatedAt"`);
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD "updatedAt" TIMESTAMP NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD "roleType" character varying NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_afcac02f3aaf4923b99b11970e" ON "payment_otps" ("paymentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_aa48db7b32c4f04a68fbe20119" ON "payment_otps" ("userId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f0f834f89f781962d41245f56e" ON "payment_otps" ("marketId") `);
        await queryRunner.query(`CREATE INDEX "IDX_f580c073d993620f1aa90cf2e8" ON "payment_otps" ("disputeId") `);
        ...
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD CONSTRAINT "FK_afcac02f3aaf4923b99b11970e7" FOREIGN KEY ("paymentId") REFERENCES "payments"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD CONSTRAINT "FK_aa48db7b32c4f04a68fbe201196" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD CONSTRAINT "FK_f0f834f89f781962d41245f56e1" FOREIGN KEY ("marketId") REFERENCES "markets"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payment_otps" ADD CONSTRAINT "FK_f580c073d993620f1aa90cf2e82" FOREIGN KEY ("disputeId") REFERENCES "disputes"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "challenges" ADD CONSTRAINT "FK_1980733727a12aad16f53de8baf" FOREIGN KEY ("creatorId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "challenges" ADD CONSTRAINT "FK_2e118d233e9fd497f473c627f06" FOREIGN KEY ("marketId") REFERENCES "markets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "challenges" ADD CONSTRAINT "FK_f2a1952cd8e95e35e5da91c4ec9" FOREIGN KEY ("outcomeId") REFERENCES "outcomes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
