...
export class AddPositionPlacedAtIndex1775972848798 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "positions" DROP CONSTRAINT "FK_ca8cf669d26fbfcc365a4811b22"`);
        await queryRunner.query(`ALTER TABLE "positions" DROP CONSTRAINT "FK_a3c43ce1fc761d6d0a4b206449c"`);
        await queryRunner.query(`ALTER TABLE "positions" DROP CONSTRAINT "FK_cc3b868c15ba2f88702f9a2866e"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_transactions_positionId"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_disputes_userId"`);
        await queryRunner.query(`ALTER TABLE "disputes" DROP CONSTRAINT "FK_disputes_marketId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_auth_methods_provider_providerId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_outcomes_marketId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_markets_status"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b2e520de4bcc291a7fd215f1dd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_positions_userId_marketId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_payments_externalPaymentId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2756723e1cddcdb37f3a37ebb4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_transactions_positionId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_transactions_paymentId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_transactions_userId"`);
        await queryRunner.query(`DROP INDEX "public"."UQ_users_telegramChatId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_telegramId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_username"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_dkCid"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_dkAccountNumber"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_users_telegramChatId"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_disputes_marketId"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "UQ_1eb2bfb05045660f5c286356413" UNIQUE ("telegramChatId")`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "reputationTier" SET DEFAULT 'rookie'`);
        await queryRunner.query(`CREATE INDEX "IDX_933827dc83a6e08eb13e4dc8ce" ON "positions" ("placedAt") `);
        await queryRunner.query(`CREATE INDEX "IDX_8c766089a2073274555d9c7483" ON "positions" ("userId", "marketId") `);
        await queryRunner.query(`CREATE INDEX "IDX_721af04ac41f7598ecb59f5e66" ON "transactions" ("paymentId") `);
        await queryRunner.query(`CREATE INDEX "IDX_26d3ddc08f3ca2799c6b5ac4d3" ON "transactions" ("positionId") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_1eb2bfb05045660f5c28635641" ON "users" ("telegramChatId") `);
        await queryRunner.query(`ALTER TABLE "positions" ADD CONSTRAINT "FK_0cf2caecfba00a6746ec1ff87a3" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "positions" ADD CONSTRAINT "FK_ba6a0153ab467b9ec02765d48f0" FOREIGN KEY ("marketId") REFERENCES "markets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "positions" ADD CONSTRAINT "FK_88182c148db063015346795a5ed" FOREIGN KEY ("outcomeId") REFERENCES "outcomes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "disputes" ADD CONSTRAINT "FK_4074d1c69ba6b998dcbe6be98e3" FOREIGN KEY ("marketId") REFERENCES "markets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
